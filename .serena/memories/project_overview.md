...
|-----------|----------|-----------|
| Engine | Rust | Axum/Tonic, FoundationDB |
| Control | Rust | Axum/Tonic, FoundationDB |
...
- **FoundationDB**: Chosen for ACID transactions, horizontal scaling, and multi-region support
